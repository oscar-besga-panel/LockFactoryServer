...
public class HolderServiceBase implements HolderService {

    private static final Logger LOGGER = LoggerFactory.getLogger(HolderServiceBase.class);

    public static final Services TYPE = HolderService.TYPE;

    private final HolderCache holderCache;

    public HolderServiceBase(LockFactoryConfiguration configuration) {
     ...
     */
    public void checkNewValue(String name, String newValue) {
