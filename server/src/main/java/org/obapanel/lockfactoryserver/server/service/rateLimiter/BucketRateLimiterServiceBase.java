...
public class BucketRateLimiterServiceBase implements BucketRateLimiterService {

    private static final Logger LOGGER = LoggerFactory.getLogger(BucketRateLimiterServiceBase.class);
    ...
    public BucketRateLimiterServiceBase(LockFactoryConfiguration configuration) {
