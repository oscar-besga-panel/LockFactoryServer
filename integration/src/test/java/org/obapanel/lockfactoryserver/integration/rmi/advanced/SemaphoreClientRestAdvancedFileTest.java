...
public class SemaphoreClientRestAdvancedFileTest {
    ...
    private final String semaphoreName = "semaphoreRmiFile888x" + System.currentTimeMillis();
    ...
    public void testIfInterruptedFor5SecondsLock() throws InterruptedException, NotBoundException, RemoteException {
        SemaphoreClientRmi semaphoreClientRmi = new SemaphoreClientRmi(LOCALHOST , getConfigurationIntegrationTestServer().getRmiServerPort(), semaphoreName);
